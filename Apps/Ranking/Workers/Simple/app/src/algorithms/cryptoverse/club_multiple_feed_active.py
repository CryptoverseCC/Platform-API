"""
Cryptoverse club multiple feed with replies and likes (sorted by time in replies and likes)
===========================================================================================

"""

from algorithms.cryptoverse import club_multiple_feed
from algorithms.utils import param


@param("id", required=True)
def run(conn_mgr, input, **params):
    result = club_multiple_feed.run(conn_mgr, input, **params)
